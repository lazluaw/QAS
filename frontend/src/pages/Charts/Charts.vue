        ...
        <div>
            <b-row>
                <b-col xs="12" lg="7">
                    ...
                    >
                        <apexchart type="bar" height="350" :series="cd.apex.column.series"
                ...
                <b-col xs="12" lg="5">
                    <Widget
                            ...
                            close collapse customHeader
                    >
                        <echart :options="cd.echarts.line" :init-options="initEchartsOptions"
                                style="height: 370px"></echart>
                    </Widget>
                </b-col>
                <b-col xs='12' lg='5'>
                    <Widget
                ...
                <b-col xs="12" lg="12">
                    <Widget
                            ...
                            close collapse customHeader
                    >
                        <echart :options="cd.echarts.river" :init-options="initEchartsOptions"
                                style="height: 350px;"></echart>
                    </Widget>
                </b-col>
            </b-row>
        </div>
