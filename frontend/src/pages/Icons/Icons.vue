        ...
        <b-tabs>
            <b-tab title="Glyphicons" active>
                ...
                <b-row class="icon-list">
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-plus"/>plus
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-euro"/>euro
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-minus"/>minus
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-cloud"/>cloud
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-glass"/>glass
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-music"/>music
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-search"
                    />search
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-heart"/>heart
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-star"/>star
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-star-empty"/>star-empty
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-user"/>user
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-film"/>film
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-off"/>off
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-signal"
                    />signal
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-cog"/>cog
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-trash"/>trash
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-home"/>home
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-file"/>file
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-time"/>time
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-road"/>road
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-inbox"/>inbox
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-flag"/>flag
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-tag"/>tag
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-tags"/>tags
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-book"/>book
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-glyph-bookmark"/>bookmark
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-print"/>print
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-glyph-camera"/>camera
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-font"/>font
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-bold"/>bold
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-align-justify"/>align-justify
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-list"/>list
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-facetime-video"/>facetime-video
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-tint"/>tint
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-edit"/>edit
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-share"/>share
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-check"/>check
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-move"/>move
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-step-backward"/>step-backward
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-fast-backward"/>fast-backward
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-backward"/>backward
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-play"/>play
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-pause"/>pause
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-stop"/>stop
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-eject"/>eject
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-chevron-left"/>chevron-left
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-chevron-right"/>chevron-right
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-question-sign"/>question-sign
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-remove-circle"/>remove-circle
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-arb-row-right"/>arb-row-right
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-exclamation-sign"/>exclamation-sign
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-gift"/>gift
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-leaf"/>leaf
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-plane"/>plane
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-glyph-calendar"/>calendar
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-shopping-cart"/>shopping-cart
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-resize-vertical"/>resize-vertical
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-resize-horizontal"/>resize-horizontal
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-hdd"/>hdd
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-circle-arb-row-left"/>circle-arb-row-left
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-circle-arb-row-top"/>circle-arb-row-up
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-circle-arb-row-down"/>circle-arb-row-down
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-globe"/>globe
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-glyph-wrench"/>wrench
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-tasks"/>tasks
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-glyph-briefcase"/>briefcase
                    </b-col>
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-glyph-paperclip"/>paperclip
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-heart-empty"/>heart-empty
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-link"/>link
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-phone"/>phone
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-glyph-pushpin"/>pushpin
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-usd"/>usd
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-gbp"/>gbp
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span class="glyphicon glyphicon-sort"/>sort
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-sort-by-alphabet"/>sort-by-alphabet
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                    ...
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-sort-by-order"/>sort-by-order
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
                            class="glyphicon glyphicon-sort-by-order-alt"/>sort-by-order-alt
                    </b-col>
                    <b-col md="4" lg="3" xs="12" class="icon-list-item"><span
