<template>
    ...
    loading: fetchingData
        ...
        <div v-if="!customControls && mainControls"
            ...
            <a @click="changeState($event, 'fullscreen')" v-if="fullscreen && state !== 'fullscreen'" href="#"
            ...
            <a @click="changeState($event, 'default')" v-if="fullscreen && state === 'fullscreen'" href="#"
        ...
        <div v-if="customControls" v-html="customControls" ref="customControlsRef"
             class="widgetControls widget-controls"></div>
